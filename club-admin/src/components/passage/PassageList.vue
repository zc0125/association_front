<template>
  <div v-if="passagePage != null">
    ...
    <el-table :data="passageData" :height="420"  stripe style="width:100%" border>
      <el-table-column prop="id" label="id" width="70" :sortable="true"></el-table-column>
      <el-table-column prop="title" label="标题" width="200" :sortable="true"></el-table-column>
      <el-table-column prop="passageType.type" label="文章类型" width="120"  :sortable="true"></el-table-column>
      <el-table-column prop="club.name" label="社团名称" width="150" :sortable="true"></el-table-column>
      <el-table-column prop="user.name" label="发布者" width="120" :sortable="true"></el-table-column>
      <el-table-column prop="publishTime" label="发布时间" width="120" :sortable="true"></el-table-column>
      <el-table-column prop="clickNum" label="点击次数" width="120"  :sortable="true"></el-table-column>
