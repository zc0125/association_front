...
export default new Router({
	...
	routes: [{
		...
		},
		{
			path: '/',
			name: 'MainUser',
			component: resolve => require(['@/MainUser.vue'],resolve),
			children: [{
				path: '/',
				name: 'HomeUser',
			...
			{
				name: 'PassageListUser',
				path: '/passages',
				component:resolve => require(['@/components/userclub/passage/PassageList'],resolve)
			},
			{
				name: 'AddPassageUser',
				path: '/passages/add.html',
				component:resolve => require(['@/components/userclub/passage/AddPassage'],resolve)
			},
			{
				name: 'EditPassageUser',
				path: '/passages/edit.html',
				component:resolve => require(['@/components/userclub/passage/EditPassage'],resolve)
			},
			{
				path: '/activities/edit.html',
				name: 'EditActivityUser',
				component:resolve => require(['@/components/userclub/activity/EditActivity'],resolve)
			},
			{
				name: 'ActivityListUser',
				path: '/activities',
				component:resolve => require(['@/components/userclub/activity/ActivityList'],resolve)
			},
			{
				path: '/activities/add.html',
				name: 'AddActivityUser',
				component:resolve => require(['@/components/userclub/activity/AddActivity'],resolve)
			},
			{
				name: 'EditClubUser',
				path: '/clubs/edit.html',
				component:resolve => require(['@/components/userclub/club/EditClub'],resolve)
			},
			{
				name: 'StudentListUser',
				path: '/clubs/student.html',
				component:resolve => require(['@/components/userclub/club/StudentList'],resolve)
			},
			]
		},

		{
			...
			children: [{
				...
				{
					path: '/admin/activities/add.html',
					name: 'AddActivity',
				...
				{
					name: 'FileTypeList',
					path: '/admin/files/types.html',
				    component:resolve => require(['@/components/file/FileTypeList'],resolve)
				},
				{
					name: 'CarouselList',
